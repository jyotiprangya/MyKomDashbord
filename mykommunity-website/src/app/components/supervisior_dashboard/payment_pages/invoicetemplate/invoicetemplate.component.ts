...
@Component({
  ...
  styleUrls: ['./invoicetemplate.component.css']
})
export class InvoicetemplateComponent implements OnInit {
  ...
  invoicehistory(){
    this.router.navigate(['/supervisor/paymentdashboard/invoicehistory']);
  }
  configamount(){
    this.router.navigate(['/supervisor/paymentdashboard/configamount']);
  }
