...
@Component({
  selector: 'app-configamount',
  templateUrl: './configamount.component.html',
  styleUrls: ['./configamount.component.css']
})
export class ConfigamountComponent implements OnInit {
