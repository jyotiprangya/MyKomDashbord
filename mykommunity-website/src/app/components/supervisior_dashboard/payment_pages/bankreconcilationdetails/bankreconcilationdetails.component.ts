...
@Component({
  selector: 'app-bankreconcilationdetails',
  templateUrl: './bankreconcilationdetails.component.html',
  styleUrls: ['./bankreconcilationdetails.component.css']
})
export class BankreconcilationdetailsComponent implements OnInit {
