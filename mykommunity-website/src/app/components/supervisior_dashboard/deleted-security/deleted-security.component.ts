...
@Component({
  selector: 'app-deleted-security',
  templateUrl: './deleted-security.component.html',
  styleUrls: ['./deleted-security.component.css']
})
export class DeletedSecurityComponent implements OnInit {
...
this.removedData.sort((a: any, b: any) => {
...
downloadCSVfile(): void {
  console.log('Filtered Data:', this.removedData); 
  ...
  const dataToExport = this.removedData.map((entry: { [x: string]: any; }) => {
  ...
  this.downloadCSV(csvContent, 'deletedSecurity_log.csv');
