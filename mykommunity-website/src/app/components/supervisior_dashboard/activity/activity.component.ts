...
columns = [
  ...
  { name: 'Approved From', visible: true },
  { name: 'Approved Till', visible: true },
  { name: 'Visitor Mobile No.', visible: true },
  { name: 'Temperature', visible: true },
  { name: 'Wearing Mask', visible: true },
  { name: 'Leave Parcel At Gate', visible: true },
  { name: 'Parcel Image', visible: true },  
  { name: 'Last Updated', visible: true },   
...
private mapColumnToKey(columnName: string): string {
  switch (columnName) {
    ...
    case 'Rental Unit': return 'rentalUnitName';
    case 'Vendor Name': return 'vendorName';
    case 'Visitor Name': return 'name';
    case 'Visitor Image': return 'image';
    case 'PassCode': return 'passcode';
    case 'Created At': return 'createdAt';
    case 'Approved From': return 'approvedFrom';
    case 'Approved Till': return 'approvedTill';
    case 'Visitor Mobile No.': return 'mobileNumber';
    case 'Temperature': return 'temperature';
    case 'Wearing Mask': return 'isWearingMask';
    case 'Leave Parcel At Gate': return 'leaveParcelAtGate';
    case 'Parcel Image': return 'imageUrl';
...
showFullparcelImage() {
  this.showparcelImage = true;
}

// Function to close the full-size image and return to the normal page
closeFullparcelImage() {
  this.showparcelImage = false;
}
open(content: any) {
